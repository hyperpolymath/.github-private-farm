...
| *Ada/SPARK*
| Safety-critical systems, formal verification, aerospace/defence.

| *Haskell*
| Pure functional, type-heavy domains, parsers, compilers.

| *Elixir*
| Distributed systems, fault-tolerant applications, real-time.
